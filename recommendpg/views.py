...
def getsphandle():
    client_credentials_manager = SpotifyClientCredentials(client_secret='f181cf771f424171829417a3ed779335',client_id='75311ed8462842a6ae8ff54a70fe4b3b')

    # client_credentials_manager = SpotifyClientCredentials(client_secret=os.environ['SPOTIFY_SECRET_KEY'],client_id=os.environ['SPOTIFY_CLIENT_ID'])
...
def home(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            results = sp.search(q=artname, limit=30)
